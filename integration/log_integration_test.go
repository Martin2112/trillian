...
var retryQueueLeavesErrFlag = flag.String("retry_queue_leaves_err", "pq: restart transaction", "Retry queue leaves if err contains this string")
...
func TestLogIntegration(t *testing.T) {
	...
	params := TestParameters{
		...
		retryQueueLeavesErr: *retryQueueLeavesErrFlag,
	}
